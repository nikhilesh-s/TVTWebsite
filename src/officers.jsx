...
const officerData = [
  ...
  },
  {
    ...
    role: "COO",
    image: officer4Image,
    description: "As the Chief Operating Officer at Tri-Valley Tech, I oversee the operational framework that ensures the execution of our projects. My role demands a balance of strategic planning and operational oversight, managing the company's daily functions while driving long-term growth. I collaborate across departments, aligning team efforts with our broader goals, and ensuring that we consistently meet quality standards.A significant part of my responsibility is streamlining processes and improving efficiency across projects. My focus is on fostering a culture of operational excellence, where innovation and efficiency go hand in hand. By ensuring that our operations are well-coordinated, I make sure our output is maximized and leverage that for better opportunities.My approach is grounded in the belief that operational success depends on a well-supported team. By cultivating a collaborative environment and leading by example, I help our team stay organized, innovative, and motivated to achieve real-world impact."
  }
];
